...
if __name__ == '__main__':
    ...
    if not args.ltokens and not args.lsyntactic and not args.lsemantic and not args.tudo and not args.lgencode:
        print(f'Não foi passado nenhum argumento. Adicione ao lado do seu {args.code} o -h para verificar as opções.')
    ...
    if args.lgencode or args.tudo:
        try:
            print('\n\n')
            print('*' * 20 + ' LOG GERAÇÃO DE CÓDIGO INTERMEDIÁRIO ' + '*' * 20, end='\n\n')
